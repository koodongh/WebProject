...
<body>
	...
	<div class="card-body">
      <form class="form-signin" method="POST" onSubmit="logincall();return false">
        <button id="btn-bad" onclick = "location.href = 'badResult'" class="btn btn-lg btn-primary btn-block" type="button">나쁜 성분 자세히 보기</button>
        <div class="bad-ingredient" >
          <h3 class="text-center">좋은 성분</h3>
          <h4 class="text-center">가나다라 마바사아</h4>
          <h4 class="text-center">가나다라 마바사아</h4>
         </div>
        <button id="btn-good" onclick = "location.href = 'goodResult'" class="btn btn-lg btn-primary btn-block" type="button">좋은 성분 자세히 보기</button>
	  </form>
     </div>
	</div>
  </div>
